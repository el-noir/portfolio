              ...
              (member) =>
                isClient && (
                  <a
                    ...
                    key={member.id}
                  >
                    <PinContainer title="Connect" href={member.linkedin}>
                      <div className="">
                        {/* Profile Image */}
                        <div className="relative flex items-center justify-center sm:w-80 w-[70vw] sm:overflow-hidden overflow-hidden h-[25vh] shadow-lg">
                          <Image
                            src={member.img}
                            alt={member.name}
                            width={120}
