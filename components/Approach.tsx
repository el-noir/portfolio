    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="I collaborate to identify potential threats and vulnerabilities in your system. We assess risks, define security goals, and develop a comprehensive strategy to protect your assets."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="Penetration Testing & Evaluation"
          icon={<AceternityIcon order="Phase 2" />}
          des="With a focus on web penetration testing, I simulate attacks to uncover vulnerabilities in your web applications. I provide detailed reports and recommendations to fortify your defenses."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="I apply the insights from testing to implement robust security measures. Post-implementation, I review and refine strategies to ensure comprehensive protection against evolving threats."
        >
          <CanvasRevealEffect
            animationSpeed={3}
